<template>
  <div class="container">
    ...
    <br/><br/>
    <h2>Genutzte Dienste</h2>
    Dieses Produkt verwendet die TMDB-API, wird aber nicht von TMDB unterstützt oder zertifiziert. <br/>
    <a href="https://www.themoviedb.org/"><img src="../assets/tmdb.svg" alt="TMDB Logo"/></a>
    <br/>
...
export default {
  ...
  mounted() {
    document.title = "Sneakprognose - Impressum";
  }
}
</script>
